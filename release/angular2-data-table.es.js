/**
 * angular2-data-table v1.1.3 (https://github.com/swimlane/angular2-data-table)
 * Copyright 2016
 * Licensed under MIT
 */
import { NgModule, KeyValueDiffers, ElementRef, Host, Component, HostListener, QueryList, ContentChildren, EventEmitter, Output, Input, Directive, TemplateRef, ContentChild, Injectable, HostBinding, ChangeDetectionStrategy, ViewContainerRef } from '@angular/core';
...
var DataTable = (function () {
    ...
    __decorate([
        ...
        __metadata('design:type', (typeof (_k = typeof QueryList !== 'undefined' && QueryList) === 'function' && _k) || Object)
    ...
    DataTable = __decorate([
        ...
        __param(0, Host()), 
        __metadata('design:paramtypes', [(typeof (_l = typeof StateService !== 'undefined' && StateService) === 'function' && _l) || Object, (typeof (_m = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _m) || Object, (typeof (_o = typeof KeyValueDiffers !== 'undefined' && KeyValueDiffers) === 'function' && _o) || Object])
    ], DataTable);
    return DataTable;
...
var DataTableHeaderFilter = (function () {
    ...
    DataTableHeaderFilter.prototype.ngOnInit = function () {
        ...
        var eventStream = Observable.fromEvent(this.element.nativeElement, 'keyup')
    ...
    DataTableHeaderFilter = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_f = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _f) || Object, (typeof (_g = typeof StateService !== 'undefined' && StateService) === 'function' && _g) || Object])
